  ...
  return (
    ...
    >
      {Array.from({ length: 4 }, (_, index) => (
        ...
        >
          <div className={`${loadingSurface} mb-4 h-9 w-[123px] rounded-[8px]`} />
          ...
          {Array.from({ length: 4 }, (_, rowIndex) => (
            ...
            >
              ...
              <div className={`${loadingSurface} mx-auto h-9 w-[100px] rounded-[8px]`} />
            </div>
          ))}
        </div>
      ))}
...
export default function FifaGroupsLoading() {
  return (
    <div role="tabpanel" className="min-w-0 pb-4" aria-label="Loading group standings">
