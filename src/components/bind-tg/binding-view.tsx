  ...
  return (
    <div className="flex h-full flex-col items-center text-center">
      ...
      <p className="m-0 mt-2 max-w-[300px] text-sm font-[400] leading-normal text-[#909090]">
        Tap <span className="text-prophet-foreground">/start/</span> in Telegram. This page
      ...
      <div className="mt-8 flex items-center gap-2">
        <span
          ...
          aria-hidden="true"
        />
        <span className="text-sm font-[500] text-prophet-foreground">Not connect yet</span>
      </div>
