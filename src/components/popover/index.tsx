...
export const Popover = forwardRef(function Popover(props: Props, ref: any) {
  ...
  const closeDelayRef = useRef<any>(null);
...
export type PopoverTrigger = (typeof PopoverTrigger)[keyof typeof PopoverTrigger];
...
const Card = (props: CardProps) => {
  ...
  useEffect(() => {
    ...
    const handleClose = (e: any) => {
      ...
      if (trigger === "Hover" && triggerRef.current?.contains(e.target)) {
        return;
      }
      onClose();
    };
