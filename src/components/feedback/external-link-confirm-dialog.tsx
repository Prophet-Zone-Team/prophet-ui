...
const dialogCardClass = cn(
  "w-full max-w-[420px] rounded-[20px] border border-prophet-line bg-prophet-panel p-[30px]",
  ...
  return (
    ...
    >
      <p className="m-0 text-sm font-[400] leading-[150%] text-prophet-muted">
        ...
        <span className="font-[500] text-prophet-foreground">{targetHost}</span>. We are not
