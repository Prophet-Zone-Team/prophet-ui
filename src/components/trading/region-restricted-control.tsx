...
export function RegionRestrictedControl({
  ...
  return (
    <Popover
      ...
      trigger="Hover"
      content={
        <div className="rounded-lg border border-prophet-line px-3 py-2 text-sm font-[400] bg-prophet-panel text-prophet-foreground shadow-[0_0_10px_0_rgba(0,0,0,0.10)]">
          {displayLabel}
        </div>
      }
    >
