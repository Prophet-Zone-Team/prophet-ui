...
export function ActionPanel({
  ...
  const orderType = orderMode === "market" ? "FAK" : "GTC";
  ...
  const preview = useMemo(
    ...
    [orderAmount, orderLimitPrice, orderMode, orderType, outcomeSide, snapshot]
  );
  ...
  const bidLabel = outcomeSide === "yes" ? "Bid for Yes" : "Bid for No";
