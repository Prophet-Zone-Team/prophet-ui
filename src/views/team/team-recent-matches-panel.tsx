        ...
        {matches.length > 0 ? (
          <div className="overflow-x-auto">
            <div className="min-w-[460px]">
              <div className="grid grid-cols-[80px_1fr_48px_72px_1fr] gap-2 border-b border-prophet-line pb-2 text-[10px] font-[500] uppercase tracking-wide text-prophet-muted">
                <span>Date</span>
                <span>Opponent</span>
                <span>Result</span>
                <span>Score</span>
