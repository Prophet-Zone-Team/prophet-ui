...
import {
  teamDetailBidButtonClass,
  teamTradeQuickAmountClass
} from "./teamDetailUi";
  ...
  return (
    <div className="flex flex-col gap-4 px-4 pb-4 pt-4">
        ...
        <div className="flex flex-wrap gap-2">
          {QUICK_AMOUNTS.map((value) => (
            <button
              key={value}
              type="button"
              className={teamTradeQuickAmountClass}
      ...
      {!session ? (
        <button
          type="button"
          className={teamDetailBidButtonClass}
