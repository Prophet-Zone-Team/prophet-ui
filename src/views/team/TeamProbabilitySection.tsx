...
import { buildTeamChartMatchAnnotations } from "../../lib/team/chartMatchAnnotations";
import {
...
} from "../../lib/team/probabilityHistory";
import type {
  OrderOutcomeSide,
...
import { TeamOrderbook } from "./TeamOrderbook";
import { TeamProbabilityChart } from "./TeamProbabilityChart";
import { teamDetailYesNoPill } from "./teamDetailUi";

const probabilityCardClass =
  "min-w-0 flex-1 rounded-[12px] border border-[#EBEBEB] bg-white p-4 sm:p-5";

export interface TeamProbabilitySectionProps {
...
export function TeamProbabilitySection({
  snapshot,
  probabilityHistory,
  matches,
  snapshots,
  showOrderbook
}: TeamProbabilitySectionProps) {
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            >
              <button
                ...
                className={cn(
                  "flex-1",
                  teamDetailYesNoPill(outcomeView === "yes", "yes")
                )}
              ...
              <button
                ...
                className={cn(
                  "flex-1",
                  teamDetailYesNoPill(outcomeView === "no", "no")
                )}
