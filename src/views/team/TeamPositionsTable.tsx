...
import { teamDetailBidButtonClass } from "./teamDetailUi";

export interface TeamPositionsTableProps {
...
export function TeamPositionsTable({ snapshot }: TeamPositionsTableProps) {
  ...
  if (needsWallet) {
    return (
      <div className="flex flex-col items-center gap-3 px-4 py-10">
        ...
        <button
          type="button"
          className={cn(teamDetailBidButtonClass, "max-w-xs")}
