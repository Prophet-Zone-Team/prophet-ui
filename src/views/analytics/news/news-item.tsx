    ...
    >
      <div className="flex items-center gap-[12px]">
        ...
        <div className="min-w-0 flex-1">
          ...
          <h3 className="m-0 mt-[4px] text-[18px] font-[400] leading-[21px] text-black">
            {item.headline}
          </h3>

          <p className="m-0 mt-[4px] text-[14px] font-[300] leading-[17px] text-[#909090]">
            {item.summary}
          </p>
        </div>

        <div className="flex min-w-[66px] shrink-0 flex-col items-end">
          <span className="whitespace-nowrap text-[12px] font-[300] leading-[14px] text-[#909090]">
            {item.publishedAtLabel}
          </span>
          <span
            className={cn(
              "mt-[8px] text-[18px] font-[400] leading-[21px]",
              isPositiveImpact ? "text-[#7BCA25]" : "text-[#FF674B]"
            )}
          >
            {formatImpactScore(item.impactScore)}
          </span>
          <span className="mt-[2px] text-[12px] font-[300] leading-[14px] text-[#909090]">
            Impact
          </span>
        </div>
      </div>
