...
import { MarketBookmarkControl } from "../home/winner/MarketBookmarkControl";
...
export function MarketListItem({ snapshot, rank }: MarketListItemProps) {
  ...
  return (
    ...
    >
      ...
      <div className="ml-auto w-1/5 flex items-center gap-2 max-lg:ml-0 max-lg:w-full max-lg:justify-end">
        <PlaceBidButton
