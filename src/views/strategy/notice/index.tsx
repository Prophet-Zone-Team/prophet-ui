      ...
      {visible ? (
        ...
        >
          ...
          <button
            type="button"
            onClick={dismiss}
            className="inline-flex h-10 w-full shrink-0 items-center justify-center rounded-lg bg-prophet-panel text-base leading-5 text-prophet-foreground transition-opacity hover:opacity-90 sm:w-32"
          >
            {t("understood")}
          </button>
        </motion.div>
