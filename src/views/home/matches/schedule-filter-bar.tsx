    ...
    <>
      ...
      >
        ...
        <label className="flex shrink-0 cursor-pointer items-center gap-2">
          ...
          />
          <span className="whitespace-nowrap text-[12px] font-normal leading-[19px] text-black md:text-[16px]">
            {t("showEnded")}
          </span>
        </label>
      </div>
...
function SortPill({
  ...
  return (
    <button
      type="button"
      className={cn(
        "inline-flex md:h-[34px] h-[30px] items-center gap-1.5 rounded-[20px] border border-[#909090] px-[10px] md:px-[16px] text-[12px] md:text-[16px] font-[400] leading-[19px] transition-colors",
