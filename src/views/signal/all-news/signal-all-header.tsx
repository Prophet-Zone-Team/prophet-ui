  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-3">
        <h2 className="m-0 min-w-0 truncate text-lg font-[400] leading-[22px] text-prophet-foreground md:text-[20px] md:leading-[24px]">
          {t("allSignalsAndNews")}
        </h2>
      ...
      <div
        ...
        className={cn(
          ...
          "mt-4 hidden text-[16px] font-[400] leading-[19px] text-prophet-muted md:flex md:mt-[22px]"
        )}
      >
...
function SortableColumnHeader({
  ...
  return (
    <button
      ...
      className={cn(
        "inline-flex items-center gap-[6px] border-0 bg-transparent p-0 text-[16px] font-[400] leading-[19px] text-prophet-muted",
        !disabled && "hover:text-prophet-foreground",
